...
<body>
	...
	<div style="width: 100%; text-align: center;">
		<form
			action="${pageContext.request.contextPath}/login?method=register"
			method="post">
			<div class="form-group">
				<label for="name">登录名</label> <input onblur="checkName()"
					style="width: auto; margin: auto;" name="name" id="name"
					type="text" class="form-control" placeholder=""> <span
					id="nameMsg">3-10位字母、数字、下划线</span>
			</div>
			<div class="form-group">
				<label for="password">密码</label> <input onblur="checkPassword()"
					style="width: auto; margin: auto;" name="password" id="password"
					type="password" class="form-control" placeholder=""> <span
					id="passwordMsg">3-20位字母、数字、下划线</span>
			</div>

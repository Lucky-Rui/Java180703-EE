	...
	<div style="width: 100%; text-align: center;">
		<form action="${pageContext.request.contextPath}/login?method=login"
			...
			<div class="form-group">
				<label for="exampleInputName1">登录名</label> <input
			...
			<div class="form-group">
				<label for="exampleInputPassword1">验证码</label> <input
					style="width: auto; margin: auto;" name="checkCode" type="text"
					class="form-control" id="exampleInputPassword1" placeholder="验证码">
				<br />
				<img id="codeImg" alt=""

	...
	<div style="width: 100%; text-align: center;">
		<form action="${pageContext.request.contextPath}/login?method=login"
			...
			<div class="form-group">
				...
				<input name="checkCode" style="width: auto; margin: auto;"
					name="checkCode" type="text" class="form-control"
					id="exampleInputPassword1" placeholder="验证码"> <br /> 
				<img id="codeImg" alt=""
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			<a class="btn btn-default" href="${pageContext.request.contextPath}/register.jsp" role="button">注册</a>
		</form>
	</div>
